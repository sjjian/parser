...
var tokenMap = map[string]int{
	...
	"AUTO_INCREMENT_CACHE_SIZE": autoIncrCacheSize,
	...
	"LINK":                       link,
	"LOB_INROW_THRESHOLD":       lobInrowThreshold,
	"IF":                       ifKwd,
	"IGNORE":                   ignore,
	"IMPORT":                   importKwd,
	"IMPORTS":                  imports,
	...
	"SESSION":                  session,
	"SEMISTRUCT_ENCODING_TYPE":  semistructEncodingType,
	"SEQUENCES":                 sequences,
	"SHARDING":                  sharding,
	"SIZE":                       sizeKwd,
	"SET":                      set,
